        ...
        <section className="bg-black ">
            <div className="max-w-7xl mx-auto text-white grid md:grid-cols-4 grid-cols-1 gap-4 pt-10 mb-5">
                <div>
                    ...
                    <p className="text-[#a4a4a4] text-[14px] mb-[0.8em] mt-4">Chào mừng bạn đến với ngôi nhà Converse! Tại đây, mỗi một dòng chữ, mỗi chi tiết và hình ảnh đều là những bằng chứng mang dấu ấn lịch sử Converse 100 năm, và đang không ngừng phát triển lớn mạnh.</p>
                </div>
                <div>
                    <h1 className="text-white font-bold text-lg ">
                        ĐỊA CHỈ
                    ...
                    <p className="text-[#a4a4a4] text-[14px] flex ">
                        <svg className="h-8 w-8 text-red-500 mr-3" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z" />  <path d="M5 4h4l2 5l-2.5 1.5a11 11 0 0 0 5 5l1.5 -2.5l5 2v4a2 2 0 0 1 -2 2a16 16 0 0 1 -15 -15a2 2 0 0 1 2 -2" />  <path d="M15 7a2 2 0 0 1 2 2" />  <path d="M15 3a6 6 0 0 1 6 6" /></svg>
                        076 922 0162</p>
                    <p className="text-[#a4a4a4] text-[14px] flex ">
                        <svg className="h-8 w-8 text-red-500 mr-3" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z" />  <rect x="3" y="5" width="18" height="14" rx="2" />  <polyline points="3 7 12 13 21 7" /></svg>
